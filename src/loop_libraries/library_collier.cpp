...
void Collier::A(std::array<std::complex<double>, A_N>& a, A_ARGS) noexcept
{
   const std::complex<double> m02 = m02_in;
...
void Collier::B(std::array<std::complex<double>, B_N>& b, B_ARGS) noexcept
{
   const std::complex<double> p10(p10_in.real(), 0.);
   const std::complex<double> m02 = m02_in;
   const std::complex<double> m12 = m12_in;
...
void Collier::C(std::array<std::complex<double>, C_N>& c, C_ARGS) noexcept
{
   const std::complex<double> p10(p10_in.real(), 0.);
   const std::complex<double> p21(p21_in.real(), 0.);
   const std::complex<double> p20(p20_in.real(), 0.);
...
void Collier::D(std::array<std::complex<double>, D_N>& d, D_ARGS) noexcept
{
   const std::complex<double> p10(p10_in.real(), 0.);
   const std::complex<double> p21(p21_in.real(), 0.);
   const std::complex<double> p32(p32_in.real(), 0.);
