...
public:
   ...
   std::complex<double> self_energy_Hp_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_Ah_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_hh_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_VG_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_VP_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_VZ_1loop_deriv_p2(double p ) const;
   std::complex<double> self_energy_VWp_1loop_deriv_p2(double p ) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fd_1loop_1_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fd_1loop_PR_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fd_1loop_PL_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fu_1loop_1_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fu_1loop_PR_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fu_1loop_PL_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fe_1loop_1_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fe_1loop_PR_deriv_p2(double p) const;
   Eigen::Matrix<std::complex<double>,3,3> self_energy_Fe_1loop_PL_deriv_p2(double p) const;
...
private:
   ...
   double DB00(double, double, double) const noexcept;
   double DB1(double, double, double) const noexcept;
