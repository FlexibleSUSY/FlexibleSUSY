...
void Weinberg_angle::enable_dvb_bsm()
{
   include_dvb_bsm = true;
}

void Weinberg_angle::disable_dvb_bsm()
{
   include_dvb_bsm = false;
}

void Weinberg_angle::set_model(const standard_model::Standard_model* model_)
{
   model = model_;
}

void Weinberg_angle::set_sm_parameters(const Sm_parameters& sm_parameters_)
{
   sm_parameters = sm_parameters_;
}
 ...
 */
std::pair<double,double> Weinberg_angle::calculate(double sinThetaW_start)
{
 ...
 */
double Weinberg_angle::calculate_rho_hat_tree() const
{
...
std::complex<double> Weinberg_angle::delta_vb_wave_Fv(int gO1) const
{
...
std::complex<double> Weinberg_angle::delta_vb_vertex(int gO1, int gO2) const
{
...
std::complex<double> Weinberg_angle::delta_vb_box(int gO1, int gO2, int gO3, int gO4) const
{
...
double Weinberg_angle::B0(double p2, double m12, double m22) const noexcept
{
...
double Weinberg_angle::C0(double m12, double m22, double m32) const noexcept
{
   return softsusy::c0(std::sqrt(m12), std::sqrt(m22), std::sqrt(m32));
}

double Weinberg_angle::D0(double m12, double m22, double m32, double m42) const noexcept
{
   return softsusy::d0(std::sqrt(m12), std::sqrt(m22), std::sqrt(m32), std::sqrt(m42));
}

double Weinberg_angle::D27(double m12, double m22, double m32, double m42) const noexcept
{
...
double Weinberg_angle::calculate_mw_pole(double sinThetaW) const
{
   ...
   sm.set_g3(model->get_g3() * standard_model_info::normalization_g3 /
