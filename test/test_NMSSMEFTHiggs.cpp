...
BOOST_AUTO_TEST_CASE( test_top_down_EFTHiggs_3loop )
{
   const struct Data {
      ...
      {slha_input_case_5, Output_3loop{ .lambda_3L = 0.11685905941993063, .Mh_3L_at_as_as = 128.06462745792598 }, 6e-3}, // MSSM reference point
      {slha_input_case_8, Output_3loop{ .lambda_3L = 0.12118666568388101, .Mh_3L_at_as_as = 128.80847592134268 }, 2e-2}, // MSSM reference point
   };
