...
Block UURMIX
  ...
  3  3     1.00000000E+00   # Re(ZUR(3,3))
   ...
   BOOST_CHECK_CLOSE_FRACTION(de, -3.2103128259718866e-13, 1e-16);

   auto dmu = CMSSMCPV_edm::calculate_edm<Fe>(m, qedqcd, 1);
   BOOST_CHECK_CLOSE_FRACTION(dmu, -6.6380036570347626e-11, 1e-16);

   auto dtau = CMSSMCPV_edm::calculate_edm<Fe>(m, qedqcd, 2);
   BOOST_CHECK_CLOSE_FRACTION(dtau, -1.1209226809367614e-09, 1e-16);
}
