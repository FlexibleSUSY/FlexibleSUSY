...
Block MSU2 Q= 8.64566215E+02
  1  1     9.37329586E+05   # mu2(1,1)
  1  2     0.00000000E+00   # mu2(1,2)
  1  3     0.00000000E+00   # mu2(1,3)
  2  1     0.00000000E+00   # mu2(2,1)
  2  2     9.37324310E+05   # mu2(2,2)
  2  3     0.00000000E+00   # mu2(2,3)
  3  1     0.00000000E+00   # mu2(3,1)
  3  2     0.00000000E+00   # mu2(3,2)
  3  3     6.35411188E+05   # mu2(3,3)
Block MSD2 Q= 8.64566215E+02
  1  1     9.28110597E+05   # md2(1,1)
  1  2     0.00000000E+00   # md2(1,2)
  1  3     0.00000000E+00   # md2(1,3)
  2  1     0.00000000E+00   # md2(2,1)
  2  2     9.28105428E+05   # md2(2,2)
  2  3     0.00000000E+00   # md2(2,3)
  3  1     0.00000000E+00   # md2(3,1)
  3  2     0.00000000E+00   # md2(3,2)
  3  3     9.18917529E+05   # md2(3,3)
Block MSOFT Q= 8.64566215E+02
    21     1.09331765E+05   # mHd2
    22    -3.77162149E+05   # mHu2
     1     2.08850012E+02   # MassB
     2     3.87896013E+02   # MassWB
     3     1.11451861E+03   # MassG
Block Phases Q= 8.64566215E+02
     1     1.00000000E+00   # Re(PhaseGlu)
Block IMPhases Q= 8.64566215E+02
     1     0.00000000E+00   # Im(PhaseGlu)
Block MASS
   1000021     1.14507765E+03   # Glu
        24     8.03633615E+01   # VWm
   1000024     3.84946651E+02   # Cha(1)
   1000037     6.43567564E+02   # Cha(2)
        25     1.14844826E+02   # hh(1)
        35     7.12647698E+02   # hh(2)
        37     7.17159958E+02   # Hpm(2)
        36     7.12376881E+02   # Ah(2)
   1000012     3.50946349E+02   # Sv(1)
   1000014     3.52110104E+02   # Sv(2)
   1000016     3.52114232E+02   # Sv(3)
   1000022     2.03765033E+02   # Chi(1)
   1000023     3.84941967E+02   # Chi(2)
   1000025    -6.29278066E+02   # Chi(3)
   1000035     6.43254463E+02   # Chi(4)
   1000001     9.55616898E+02   # Sd(1)
   1000003     9.95172640E+02   # Sd(2)
   1000005     9.98169152E+02   # Sd(3)
   2000001     9.98172939E+02   # Sd(4)
   2000003     1.04379200E+03   # Sd(5)
   2000005     1.04379385E+03   # Sd(6)
   1000011     2.22944691E+02   # Se(1)
   1000013     2.30022228E+02   # Se(2)
   1000015     2.30047372E+02   # Se(3)
   2000011     3.61034665E+02   # Se(4)
   2000013     3.61038910E+02   # Se(5)
   2000015     3.62164628E+02   # Se(6)
   1000002     7.94247719E+02   # Su(1)
   1000004     1.00025984E+03   # Su(2)
   1000006     1.00165303E+03   # Su(3)
   2000002     1.00272702E+03   # Su(4)
   2000004     1.04091772E+03   # Su(5)
   2000006     1.04091837E+03   # Su(6)
        21     0.00000000E+00   # VG
        12     0.00000000E+00   # Fv(1)
        14     0.00000000E+00   # Fv(2)
        16     0.00000000E+00   # Fv(3)
        11     5.30293257E-04   # Fe(1)
        13     1.07502298E-01   # Fe(2)
        15     1.78881710E+00   # Fe(3)
         1     4.61593289E-03   # Fd(1)
         3     9.13029950E-02   # Fd(2)
         5     3.39894589E+00   # Fd(3)
         2     2.32430765E-03   # Fu(1)
         4     8.55208175E-01   # Fu(2)
         6     1.73822606E+02   # Fu(3)
        22     0.00000000E+00   # VP
        23     9.11298856E+01   # VZ
Block UMIX
  1  1     9.57429769E-01   # Re(UM(1,1))
  1  2    -2.88666307E-01   # Re(UM(1,2))
  2  1     2.88666307E-01   # Re(UM(2,1))
  2  2     9.57429769E-01   # Re(UM(2,2))
Block VMIX
  1  1     9.80920735E-01   # Re(UP(1,1))
  1  2    -1.94408105E-01   # Re(UP(1,2))
  2  1     1.94408105E-01   # Re(UP(2,1))
  2  2     9.80920735E-01   # Re(UP(2,2))
Block PSEUDOSCALARMIX
  1  1    -9.89804862E-02   # ZA(1,1)
  1  2     9.95089375E-01   # ZA(1,2)
  2  1     9.95089375E-01   # ZA(2,1)
  2  2     9.89804862E-02   # ZA(2,2)
Block DSQMIX
  1  1    -0.00000000E+00   # ZD(1,1)
  1  2    -0.00000000E+00   # ZD(1,2)
  1  3    -9.74106343E-01   # ZD(1,3)
  1  4    -0.00000000E+00   # ZD(1,4)
  1  5    -0.00000000E+00   # ZD(1,5)
  1  6    -2.26090319E-01   # ZD(1,6)
  2  1     0.00000000E+00   # ZD(2,1)
  2  2     0.00000000E+00   # ZD(2,2)
  2  3     2.26090319E-01   # ZD(2,3)
  2  4     0.00000000E+00   # ZD(2,4)
  2  5     0.00000000E+00   # ZD(2,5)
  2  6    -9.74106343E-01   # ZD(2,6)
  3  1     0.00000000E+00   # ZD(3,1)
  3  2     4.57005191E-03   # ZD(3,2)
  3  3     0.00000000E+00   # ZD(3,3)
  3  4     0.00000000E+00   # ZD(3,4)
  3  5     9.99989557E-01   # ZD(3,5)
  3  6     0.00000000E+00   # ZD(3,6)
  4  1     2.08734878E-04   # ZD(4,1)
...
Block NMIX
  ...
  1  2     1.78138157E-02   # Re(ZN(1,2))
  1  3    -8.39671889E-02   # Re(ZN(1,3))
  1  4     3.50523356E-02   # Re(ZN(1,4))
  2  1     3.91216670E-02   # Re(ZN(2,1))
  2  2     9.69238433E-01   # Re(ZN(2,2))
  2  3    -2.01735418E-01   # Re(ZN(2,3))
  2  4     1.35459128E-01   # Re(ZN(2,4))
  3  1     3.35071393E-02   # Re(ZN(3,1))
  3  2    -4.87542667E-02   # Re(ZN(3,2))
  3  3    -7.03377609E-01   # Re(ZN(3,3))
  3  4    -7.08350360E-01   # Re(ZN(3,4))
  4  1     7.70925020E-02   # Re(ZN(4,1))
  4  2    -2.40587923E-01   # Re(ZN(4,2))
  4  3    -6.76396534E-01   # Re(ZN(4,3))
  4  4     6.91853978E-01   # Re(ZN(4,4))
Block CHARGEMIX
  1  1    -9.95719442E-02   # ZP(1,1)
  1  2     9.95030365E-01   # ZP(1,2)
  2  1     9.95030365E-01   # ZP(2,1)
  2  2     9.95719442E-02   # ZP(2,2)
Block USQMIX
  1  1     0.00000000E+00   # ZU(1,1)
  1  2     1.18726335E-16   # ZU(1,2)
  1  3     4.27858606E-01   # ZU(1,3)
  1  4     0.00000000E+00   # ZU(1,4)
  1  5     7.49566980E-17   # ZU(1,5)
  1  6     9.03845680E-01   # ZU(1,6)
  2  1    -0.00000000E+00   # ZU(2,1)
  2  2    -9.27975877E-03   # ZU(2,2)
  2  3    -1.82603591E-14   # ZU(2,3)
  2  4    -0.00000000E+00   # ZU(2,4)
  2  5    -9.99956942E-01   # ZU(2,5)
  2  6     8.72495511E-15   # ZU(2,6)
  3  1     2.02956458E-05   # ZU(3,1)
...
Block FlexibleSUSYOutput
     ...
     1     8.64566215E+02   # SUSYScale
     2     9.11876000E+01   # LowScale
Block ALPHA
          -1.06834219E-01   # ArcSin(Pole(ZH(2,2)))
Block HMIX Q= 8.64566215E+02
     1     6.23808469E+02   # Mu
     2     9.67481747E+00   # vu/vd
     3     2.44130978E+02   # Sqrt(Sqr(vd) + Sqr(vu))
     4     5.26379366E+05   # Sqr(MAh(2))
   101     5.38320467E+04   # BMu
   102     2.50999305E+01   # vd
   103     2.42837246E+02   # vu
Block Au Q= 8.64566215E+02
  1  1    -1.13135345E+03   # TYu(1,1)/Yu(1,1)
  2  2    -1.13134843E+03   # TYu(2,2)/Yu(2,2)
  3  3    -8.73285748E+02   # TYu(3,3)/Yu(3,3)
Block Ad Q= 8.64566215E+02
  1  1    -1.38518583E+03   # TYd(1,1)/Yd(1,1)
  2  2    -1.38518118E+03   # TYd(2,2)/Yd(2,2)
  3  3    -1.29472418E+03   # TYd(3,3)/Yd(3,3)
Block Ae Q= 8.64566215E+02
  1  1    -2.99353468E+02   # TYe(1,1)/Ye(1,1)
  2  2    -2.99347672E+02   # TYe(2,2)/Ye(2,2)
  3  3    -2.97714153E+02   # TYe(3,3)/Ye(3,3)
Block MSOFT Q= 8.64566215E+02
     1     2.08850012E+02   # MassB
     2     3.87896013E+02   # MassWB
     3     1.11451861E+03   # MassG
    21     1.09331765E+05   # mHd2
    22    -3.77162149E+05   # mHu2
    31     3.53550630E+02   # SignedAbsSqrt(ml2(1,1))
    32     3.53547067E+02   # SignedAbsSqrt(ml2(2,2))
    33     3.52542852E+02   # SignedAbsSqrt(ml2(3,3))
    34     2.22260278E+02   # SignedAbsSqrt(me2(1,1))
    35     2.22248713E+02   # SignedAbsSqrt(me2(2,2))
    36     2.18968837E+02   # SignedAbsSqrt(me2(3,3))
    41     1.00699572E+03   # SignedAbsSqrt(mq2(1,1))
    42     1.00699316E+03   # SignedAbsSqrt(mq2(2,2))
    43     9.28348152E+02   # SignedAbsSqrt(mq2(3,3))
    44     9.68157831E+02   # SignedAbsSqrt(mu2(1,1))
    45     9.68155106E+02   # SignedAbsSqrt(mu2(2,2))
    46     7.97126833E+02   # SignedAbsSqrt(mu2(3,3))
    47     9.63384968E+02   # SignedAbsSqrt(md2(1,1))
    48     9.63382286E+02   # SignedAbsSqrt(md2(2,2))
    49     9.58601862E+02   # SignedAbsSqrt(md2(3,3))
)";
   ...
   // h -> gluon gluon
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_hh_to_VGVG(&m, 0), 0.00029107801549747592, 10*eps);
   // h -> gamma gamma
   ...
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_hh_to_VPVP(&m, 0), 7.271047934944202e-06, 10*eps);
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_hh_to_VPVZ(&m, 0), 2.2198080013381038e-06, 10*eps);

   // pseudoscalar Higgs
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_Ah_to_VGVG(&m, 1), 0.00043378057279629952, eps);

   // ------------ tree-level decays ------------

   // Ah -> b bbar
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_Ah_to_barFdFd(&m, 1, 2, 2),
                              0.88658108806852576, eps);
   // Ah -> tau+ tau-
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_Ah_to_barFeFe(&m, 1, 2, 2),
                              0.14370134308297239, eps);
   // Ah -> c cbar
   // @todo(Ah(0) is an unphysical Goldstone, which is not written to SLHA)
   ...
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_Ah_to_VGVG(&m, 1), 0.00043378057279629952, eps);
   // Ah -> gamma gamma
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_Ah_to_VPVP(&m, 1), 4.1843910938310874e-06, eps);
   ...
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_barFdFd(&m, 0, 2, 2),
                              0.0013683067977931381, eps);
   // h -> c cbar
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_barFuFu(&m, 0, 1, 1),
                              7.6128484411953055e-05, eps);
   // h -> tau+ tau-
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_barFeFe(&m, 0, 2, 2),
                              0.0002595600030762401, 10*eps);
   // h -> gamma gamma
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_VPVP(&m, 0), 7.1507053618014637e-06, 10*eps);

   // h -> gluon gluon
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_VGVG(&m, 0), 9.381223898157936e-05, 10*eps);
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_VPVZ(&m, 0), 2.2198080013381038e-06, 10*eps);

   // Ah -> gluon gluon
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_Ah_to_VGVG(&m, 1), 0.00043378057279629952, eps);
   // Ah -> gamma gamma
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_Ah_to_VPVP(&m, 1), 4.0630566804965507e-06, eps);
   // Ah -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_Ah_to_VPVZ(&m, 1), 9.3179924792926659e-06, 10*eps);
