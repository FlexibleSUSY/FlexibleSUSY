...
*)
<<"~/Promotion/Development_FS/FlexibleSUSY/meta/TestSuite.m"
SetDirectory["~/Promotion/Development_FS/FlexibleSUSY"]
...
(*DeltaMh1l;*)
DeltaMh21l = 2 yt^2v^2 k(\[Lambda] (2+3Lt)/2 - 3yt^2 Lt)+ 2 yb^2 v^2 k(\[Lambda] (2+3Lb)/2 - 3yb^2 Lb)/. 
	{Lt -> Log[t/Q^2], Lb-> Log[b/Q^2]}/.
	{b -> mb^2, t -> mt^2} /.
    {mt -> v yt/Sqrt[2], mb -> v yb/Sqrt[2]};
 
(*Derived contributions which are tested;*)   
Mh22lEffPot=- ((8 (k^2 mt^6 (6+\[Pi]^2+3 Log[mt^2/Q^2] (-7+3 Log[mt^2/Q^2]))))/v^4)+
(24 k^2 mt^6 (\[Pi]^2+Log[mt^2/Q^2]+3 Log[mt^2/Q^2]^2) (mb/mt)^2)/v^4+
1/v^4 12 k^2 mt^6 (-15-2 \[Pi]^2+2 Log[mt^2/Q^2]+6 Log[mt^2/Q^2]^2+8 Log[mb/mt] (2+3 Log[mt^2/Q^2])) (mb/mt)^4+
1/(3 v^4) 4 k^2 mt^6 (49+6 \[Pi]^2-144 Log[mb/mt]^2+24 Log[mb/mt] (5-9 Log[mt^2/Q^2])+18 (7-3 Log[mt^2/Q^2]) Log[mt^2/Q^2]) (mb/mt)^6;

(*2-loop contributions which come from momentum iteration;*) 
Mh22lpIter=( (k^2 mt^2 2(2+3 Log[mt^2/Q^2]))/v^4+(k^2 mb^2 2(2+3 Log[mb^2/Q^2]))/v^4)(-24 mt^4 Log[mt^2/Q^2] - 24 mb^4 Log[mb^2/Q^2]);
    
DelMh2=Mh22lpIter+Mh22lEffPot + DeltaMh21l + Mh20l;
DMh20L = Coefficient[DelMh2, k, 0];
DMh21L = Coefficient[DelMh2, k, 1];
DMh22L = Coefficient[DelMh2, k, 2];
