...
Block FlexibleSUSYLowEnergy Q= 1.00000000E+03
   ...
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_hh_to_VPVZ(&m, 0), 7.8803489809960472e-06, 7e-11);
   ...
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_VPVZ(&m, 0), 7.8803489809960472e-06, 7e-11);
