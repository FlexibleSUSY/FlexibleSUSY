...
Block IMVCKM Q= 1.00000000E+03
  ...
  3  3     0.00000000E+00   # Im(CKM)(3,3)
   ...
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_with_HO.partial_width_hh_to_VPVZ(&m, 0), 7.8803492070500402e-06, 5e-11);
   ...
   // h -> gamma Z
   BOOST_CHECK_CLOSE_FRACTION(decays_without_HO.partial_width_hh_to_VPVZ(&m, 0), 7.8803492070500402e-06, 5e-11);
