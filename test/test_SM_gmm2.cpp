...
BOOST_AUTO_TEST_CASE( test_zero )
{
   ...
   const double ae = SM_a_muon::calculate_a_muon<Fe>(sm, qedqcd, 0);
   const double amu = SM_a_muon::calculate_a_muon<Fe>(sm, qedqcd, 1);
   const double atau = SM_a_muon::calculate_a_muon<Fe>(sm, qedqcd, 2);
